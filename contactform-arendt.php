...
<?php
	...
	// create page object
	$page = new Template();
	$page->setTitle('Contact Form | Arendt | Special Collection | Bard College');
	$page->setSubHeading('Arendt Request Form');

	// print page header
	$page->open();
?>
<form id="rForm" action="verify-request-form-arendt.php" method="post">
