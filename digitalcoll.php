	...
	<div class="right-content inside-page digital-collection">
		<div class="important-info content-item">
			...
			<div>
				...
				<!-- <div class="grid-4">
					<img src="https://www.bard.edu/archives/images/collectionimages/bardarchitecture.jpg" alt="Aspinwall (Occident) Hall, ca. 1890. Bard College Architecture Collection.">
					<img src="https://www.bard.edu/archives/images/collectionimages/bardpapers.jpg" alt="Nathaniel Pendleton letter to William Bard, July 26, 1804. Bard Family Papers.">
					<img src="images/digicoll/john johnston bard.png" alt="John Bard, ca. 1863. Bard - Tivoli History; Bard Family Papers.">
					<img src="https://www.bard.edu/archives/images/collectionimages/digcol-4.jpg" alt="Hoffman Memorial Library Reading Room, ca. 1950. Bard Architecture Collection.">
					<img src="https://www.bard.edu/archives/images/collectionimages/digcol-5.jpg" alt="Bard Observer issue. Bard College Student Newspaper Archive.">
					<img src="https://www.bard.edu/archives/images/collectionimages/tivoli.jpg" alt="Bayly's Bar, ca. 1975. Tivoli Collection.">
					<img src="https://www.bard.edu/archives/images/collectionimages/ward.jpg" alt="Boy campers harvesting vegetables, ca. 1940. Ward Manor Collection.">
				</div> -->
				
				<div class="exhibits-item grid-4">
					<div class="exhibits-image">
						<a href="images/digicoll/bard college arch.png" target="_blank">
							<img src="images/digicoll/bard college arch.png" alt="Interior of Albee Social">
						</a>
						<p class="small-font flex-center">Interior of Albee Social, ca. 1935</p>
					</div>
					<div class="exhibits-text">
						<h3><a target="_blank" href="https://nyheritage.org/collections/bard-college-architecture-past-and-present">Bard College Architecture, Past and Present Collection</a> <img src="https://nyheritage.org/sites/default/files/NYH_Logo_Small.png" alt="hrvh" width="100" height="39.5333" border="0" align="absmiddle" style="width: inherit !important;"> </h3>
						<p>This collection contains photographs related to all buildings of Bard College, past and present.</p>
					</div>
				</div>
				...
				<!-- <div class="exhibits-item grid-4">
					<div class="exhibits-image">
						<a href="#" target="_blank">
							<img src="http://blogs.bard.edu/library/files/2021/09/FoldCutStitchPoster.png" alt="Fold Cut Stitch">
						</a>
						<p class="small-font flex-center">Advertisement from display exhibit.</p>
					</div>
					<div class="exhibits-text">
						<h3><a href="#">Fold Cut Stitch</a></h3>
						<p>Fold Cut Stitch: Selections from the Stevenson Library Artists' Books Collection</p>
					</div>
				</div> -->
				
				<!-- <h3><a target="_blank" href="https://nyheritage.org/collections/arendtiana-collection">Arendtiana Collection</a> <img src="https://nyheritage.org/sites/default/files/NYH_Logo_Small.png" alt="hrvh" width="100" height="39.5333" border="0" align="absmiddle" style="width: inherit !important;"> </h3>
				<p>The Arendtiana Collection is intended to gather materials closely  related to the life and work of Hannah Arendt. It is a small  supplemental collection to the Hannah Arendt Library, a collection of  materials discovered in her library at the time of her death and now  maintained at the Stevenson Library, Bard College.</p> -->
