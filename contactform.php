<?php
	...
	// create page object
	$page = new Template();
	$page->setTitle('Contact Form | Archives | Special Collection | Bard College');
	$page->setSubHeading('Archives Request Form');

	// print page header
	$page->open();
?>
<form id="rForm" action="verify-request-form.php" method="post">
