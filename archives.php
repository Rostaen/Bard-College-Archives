...
// print page header
$page->open();
// Grabbing exhibit function
function exhibitItem($imgURL, $imgAlt, $imgComment, $title, $bodyContent)
{
	echo '
	...
	if ($imgComment != '')
		echo '<p class="small-font flex-center">' . $imgComment . '</p>';
	echo '</div>
...
<div class="right-content inside-page">
	<div class="important-info content-item">
		...
		<div>
			...
			<?php
			for ($x = 0; $x < 3; $x++)
				exhibitItem($exhibitData[$x][0], $exhibitData[$x][1], $exhibitData[$x][2], $exhibitData[$x][3], $exhibitData[$x][4]);
			?>
			...
			<?php
			exhibitItem($exhibitData[4][0], $exhibitData[4][1], $exhibitData[4][2], $exhibitData[4][3], $exhibitData[4][4]);
			?>

			<h2>2. Local and Regional History Archives: Wiles Collection</h2>

			<?php
			exhibitItem($exhibitData[5][0], $exhibitData[5][1], $exhibitData[5][2], $exhibitData[5][3], $exhibitData[5][4]);
			?>

			<h2>3. Delafield Family/ Montgomery Place Archives</h2>

			<?php
			exhibitItem($exhibitData[6][0], $exhibitData[6][1], $exhibitData[6][2], $exhibitData[6][3], $exhibitData[6][4]);
			?>
